...
See [docs/DISTRIBUTED_MODE.md](docs/DISTRIBUTED_MODE.md), [docs/NETWORK_MVP.md](docs/NETWORK_MVP.md), [docs/AUDIT_SCHEMA.md](docs/AUDIT_SCHEMA.md), [docs/MVP_SPEC.md](docs/MVP_SPEC.md), [docs/ENGINE_OPTIONS.md](docs/ENGINE_OPTIONS.md), [docs/APSI_FEASIBILITY.md](docs/APSI_FEASIBILITY.md), [docs/SECRETFLOW_DUE_DILIGENCE.md](docs/SECRETFLOW_DUE_DILIGENCE.md), [docs/OPENMINED_DUE_DILIGENCE.md](docs/OPENMINED_DUE_DILIGENCE.md), [docs/WIRE_TRAFFIC_NOTES.md](docs/WIRE_TRAFFIC_NOTES.md), and [docs/OPENMINED_WIRE_TRAFFIC_NOTES.md](docs/OPENMINED_WIRE_TRAFFIC_NOTES.md) for the deeper operational material.
